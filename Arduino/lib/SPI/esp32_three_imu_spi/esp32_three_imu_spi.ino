...
#define CS_PIN_1 26   // Which pin you connect CS to for Sensor 1
#define CS_PIN_2 25   // Which pin you connect CS to for Sensor 2
#define CS_PIN_3 33    // Which pin you connect CS to for Sensor 3
