...
class BLEClass:
    ...
    async def connect_to_device(self):
        ...
        async with BleakClient(self.address, disconnected_callback=self.handle_disconnect) as client:
            ...
            try:
                ...
                while True:
                    ...
                    if self.sendcommand:
                        ...
                        if self.command in [ b's\n',b'r\n',b't\n',b'c\n']:
                            # print("press start",self.command)
...
def main():
    ...
    # IMU1 = {"name": "left#1", "address": "F45E7C56-20A1-487C-AA49-9137616CFF97", "path": "left.txt"}
    # IMU2 = {"name": "right#1", "address": "4A2E4807-BA85-444A-BF19-3752CF6E71B2", "path": "right.txt"}

    IMU1 = {"name": "left#2", "address": "737F739D-57CA-4738-B84A-1F34C59783E5", "path": "left.txt"}
    IMU2 = {"name": "right#2", "address": "2A9F4C95-0B8A-4389-B697-834378A0A51B", "path": "right.txt"}
