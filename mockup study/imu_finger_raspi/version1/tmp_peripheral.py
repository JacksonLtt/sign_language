...
# BLE Mac
peri1_mac = ['left#1', '2A9F4C95-0B8A-4389-B697-834378A0A51B']
peri2_mac = ['right#1', 'F45E7C56-20A1-487C-AA49-9137616CFF97']
peri3_mac = ['ear#1', '24030208-6F3F-4F9A-BCB9-BC7C39F05388']
...
if __name__ == "__main__":
    ...
    imu = {"name": "right", "address": '4A2E4807-BA85-444A-BF19-3752CF6E71B2', "path": "right.txt"}
