...
class Transformer(nn.Module):
    ...
    def __init__(
        ...
        #         nn.Linear(int(d_model/4),n_trg_vocab),
        #         # nn.ReLU(),
        # )
    ...
    # def last_layer(self, C):
    #     return nn.Sequential(
    #             nn.Linear(self.d_model,int(self.d_model/4)),
    #             nn.BatchNorm1d(C),
    #             # nn.ReLU(),
    #             nn.Dropout(p=self.dropout),
    #             nn.Linear(int(self.d_model/4),self.n_trg_vocab),
    #             # nn.ReLU(),
    #     )
    ...
    def forward(self, 
                src_seq, 
                trg_seq):
        # print("src_is_text:", self.src_is_text)
        # if self.src_is_text:
        #
